const SKILL_DEMAND: Record<string, {
  ...
  "NLP": { level: "hot", label: "🔥 Hot", trend: "+61% YoY" },
  "Data Engineering": { level: "hot", label: "🔥 Hot", trend: "+43% YoY" },
  "Cybersecurity": { level: "hot", label: "🔥 Hot", trend: "+35% YoY" },
  ...
  "Node.js": { level: "high", label: "📈 High", trend: "+21% YoY" },
  "Google Cloud Platform": { level: "high", label: "📈 High", trend: "+27% YoY" },
